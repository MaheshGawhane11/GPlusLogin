...
public class MainActivity extends Activity implements OnClickListener, ConnectionCallbacks,
	...
	public void onClick(View v)
	{
		...
		switch (id)
		{
			...
			case R.id.show_userinfo_button:
				userOptionsLayout.setVisibility(View.GONE);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data)
	{
		...
		else if (requestCode == PICK_MEDIA_REQUEST_CODE)
		{
			...
			if (resultCode == RESULT_OK)
			{
				...
				share.setType(mime);
				startActivityForResult(share.getIntent(), SHARE_MEDIA_REQUEST_CODE);
			}
		}
	}
	...
	private void processUserInfoAndUpdateUI()
	{
		...
		Log.i("signedInUser",""+signedInUser);
	...
	private class UpdateProfilePicTask extends AsyncTask<String, Void, Bitmap>
	{
		...
		{
			profileView = new WeakReference<ImageView>(img);
		}
